	...
	<body>
		...
		<form action = "display.php" method = "GET">	
			<div class = "container">
						...
						<?php
							...
							if($result->num_rows > 0){
								while($row = $result->fetch_assoc()){
									...
									<center><button type="button" name="updatebtn" onclick="window.location.href='updateProf.php'">UPDATE PROFILE</button></center>
									<?php
								}}
						?>
					</div>
				...
				<div class = "main">
					<ul>
						<li><a href = "available.php">CAR AVAILABLE</li>
						<li><a href = "">RENT OUR CAR</li>
